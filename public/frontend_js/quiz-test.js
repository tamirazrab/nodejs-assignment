...
async function askQuestion(totalQuizQuestions, counter, fromBack) {
  ...
  console.log("🚀 ~ file: quiz-test.js ~ line 941 ~ askQuestion ~ askQuestion")
  ...
  if (type == 1) {
    ...
    const totalOptions = ques.answers.length

    ques.answers.forEach((val, index) => {
      console.log("🚀 ~ file: quiz-test.js ~ line 1214 ~ ques.answers.forEach ~ index", index)
      if (val.answer) {
